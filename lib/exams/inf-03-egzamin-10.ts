/**
 * Single source of truth dla arkusza INF.03 / styczeń 2026 / 10.
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-10-styczen-2026",
    examId: "INF.03-10",
    session: "Styczeń 2026",
    title: "Arkusz 10 — Blog kulinarny",
    topic: "Blog kulinarny",
    description:
...
export const examSteps: ExamStep[] = [
    {
        ...
        label: "Baza danych",
        short: "Baza",
        summary: "Potrawy, rodzaje, alergeny, JOIN n:m i dane przepisu.",
        minutes: "0–25 min",
        technologies: ["SQL", "MySQL"],
        mdx: () => import("@/content/inf-03/egzamin-10-styczen-2026/baza-danych.mdx"),
    },
    {
        slug: "html",
        index: 2,
        label: "HTML",
        short: "HTML",
        summary: "Przepisy.php: aside z linkami, main z treścią potrawy i section z tłem.",
        minutes: "25–45 min",
        technologies: ["HTML"],
        mdx: () => import("@/content/inf-03/egzamin-10-styczen-2026/html.mdx"),
    },
    {
        slug: "php",
        index: 3,
        label: "PHP",
        short: "PHP",
        summary: "Parametr GET, cztery skrypty PHP, alergeny i tło sekcji pobrane z bazy.",
        minutes: "45–95 min",
        technologies: ["PHP", "MySQL"],
        mdx: () => import("@/content/inf-03/egzamin-10-styczen-2026/php.mdx"),
    },
    {
        slug: "css",
        index: 4,
        label: "CSS",
        short: "CSS",
        summary: "Layout bloga, tło sekcji, separator i typografia zgodne z makietą.",
        minutes: "95–130 min",
        technologies: ["CSS"],
        mdx: () => import("@/content/inf-03/egzamin-10-styczen-2026/css.mdx"),
    },
    {
        slug: "kontrola",
        index: 5,
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-10-styczen-2026/kontrola.mdx"),
    },
];
...
export const examMaterials = {
    ...
    result: {
        ...
        alt: "Makieta lub wynik końcowy INF.03-10 — Blog kulinarny",
        title: "e10-kw4.png",
