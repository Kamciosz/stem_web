...
export const examMeta: ExamMeta = {
    ...
    scoringTotal: "30 pkt",
    objective: "System wykazow z baza.",
};

export const examSteps: ExamStep[] = [
    { slug: "baza-danych", index: 1, label: "Baza danych", short: "Baza", summary: "Schemat + 4 kwerendy SQL.", minutes: "0-25 min", technologies: ["SQL"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2025/baza-danych.mdx") },
    { slug: "html-php", index: 2, label: "PHP", short: "Etap 2", summary: "Polaczenie, renderowanie.", minutes: "25-90 min", technologies: ["PHP"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2025/html-php.mdx") },
    { slug: "css", index: 3, label: "CSS", short: "CSS", summary: "Makieta z arkusza.", minutes: "90-130 min", technologies: ["CSS"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2025/css.mdx") },
    { slug: "kontrola", index: 4, label: "Kontrola", short: "Kontrola", summary: "Ostatnie 20 minut.", minutes: "130-150 min", technologies: ["QA"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2025/kontrola.mdx") },
];
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-07-styczen-2025:checklist";
