...
export type ExamMeta = {
    courseId: "inf-03";
    lessonSlug: "egzamin-06-czerwiec-2025";
    examId: string;
    session: string;
    title: string;
    topic: string;
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-06-czerwiec-2025",
    examId: "INF.03-06-CZ25",
    session: "Czerwiec 2025",
    title: "Arkusz 06 — Biblioteka",
    topic: "Biblioteka",
    description: "System wypozyczalni.",
    rule: "SQL → PHP → CSS → Kontrola",
    time: "150 min",
    technologies: ["PHP", "SQL", "CSS"],
    scoreTarget: "~22 / 30 pkt",
    scoringTotal: "30 pkt",
    objective: "System wypozyczalni.",
};
...
export const examSteps: ExamStep[] = [
    {
        ...
        mdx: () => import("@/content/inf-03/egzamin-06-czerwiec-2025/baza-danych.mdx"),
    },
    {
        slug: "html-php",
        index: 2,
        ...
        minutes: "25–90 min",
        technologies: ["PHP"],
        mdx: () => import("@/content/inf-03/egzamin-06-czerwiec-2025/html-php.mdx"),
    },
    {
        slug: "css",
        index: 3,
        ...
        minutes: "90–130 min",
        technologies: ["CSS"],
        mdx: () => import("@/content/inf-03/egzamin-06-czerwiec-2025/css.mdx"),
    },
    {
        slug: "kontrola",
        index: 4,
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-06-czerwiec-2025/kontrola.mdx"),
    },
];
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-06-czerwiec-2025:checklist";
