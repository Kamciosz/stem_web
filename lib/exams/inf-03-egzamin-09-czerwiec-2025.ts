...
export type ExamMeta = {
    courseId: "inf-03";
    lessonSlug: "egzamin-09-czerwiec-2025";
    examId: string;
    session: string;
    title: string;
    topic: string;
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-09-czerwiec-2025",
    examId: "INF.03-09-CZ25",
    session: "Czerwiec 2025",
    title: "Arkusz 09 — Remonty",
    topic: "Remonty",
    description: "Firma remontowa — kwerendy i zlecenia.",
    rule: "SQL → PHP → CSS → Kontrola",
    time: "150 min",
    technologies: ["PHP", "SQL", "CSS"],
    scoreTarget: "~22 / 30 pkt",
    scoringTotal: "30 pkt",
    objective: "Firma remontowa — kwerendy i zlecenia.",
};
...
export const examSteps: ExamStep[] = [
    {
        ...
        mdx: () => import("@/content/inf-03/egzamin-09-czerwiec-2025/baza-danych.mdx"),
    },
    {
        slug: "html-php",
        index: 2,
        ...
        minutes: "25–90 min",
        technologies: ["PHP"],
        mdx: () => import("@/content/inf-03/egzamin-09-czerwiec-2025/html-php.mdx"),
    },
    {
        slug: "css",
        index: 3,
        ...
        minutes: "90–130 min",
        technologies: ["CSS"],
        mdx: () => import("@/content/inf-03/egzamin-09-czerwiec-2025/css.mdx"),
    },
    {
        slug: "kontrola",
        index: 4,
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-09-czerwiec-2025/kontrola.mdx"),
    },
];
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-09-czerwiec-2025:checklist";
