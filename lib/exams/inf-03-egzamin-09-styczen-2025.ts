...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-09-styczen-2025",
    examId: "INF.03-09-ST25",
    session: "Styczeń 2025",
    title: "Arkusz 09 — Zdobywcy",
    topic: "Zdobywcy",
    description: "Baza zdobywcow górskich szczytów.",
    rule: "SQL → PHP → CSS → Kontrola",
    time: "150 min",
    technologies: ["PHP", "SQL", "CSS"],
    scoreTarget: "~22 / 30 pkt",
    scoringTotal: "30 pkt",
    objective: "Baza zdobywcow górskich szczytów.",
};

export const examSteps: ExamStep[] = [
    { slug: "baza-danych", index: 1, label: "Baza danych", short: "Baza", summary: "Schemat + 4 kwerendy SQL.", minutes: "0-25 min", technologies: ["SQL"], mdx: () => import("@/content/inf-03/egzamin-09-styczen-2025/baza-danych.mdx") },
    { slug: "html-php", index: 2, label: "PHP", short: "Etap 2", summary: "Polaczenie, renderowanie.", minutes: "25-90 min", technologies: ["PHP"], mdx: () => import("@/content/inf-03/egzamin-09-styczen-2025/html-php.mdx") },
    { slug: "css", index: 3, label: "CSS", short: "CSS", summary: "Makieta z arkusza.", minutes: "90-130 min", technologies: ["CSS"], mdx: () => import("@/content/inf-03/egzamin-09-styczen-2025/css.mdx") },
    { slug: "kontrola", index: 4, label: "Kontrola", short: "Kontrola", summary: "Ostatnie 20 minut.", minutes: "130-150 min", technologies: ["QA"], mdx: () => import("@/content/inf-03/egzamin-09-styczen-2025/kontrola.mdx") },
];
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-09-styczen-2025:checklist";
