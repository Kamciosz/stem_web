...
export const examMeta: ExamMeta = { courseId: "inf-03", lessonSlug: "egzamin-07-styczen-2024", examId: "INF.03-07", session: "Styczeń 2024", title: "Arkusz 07 — Salon", topic: "Salon", description: "Projekt Salon.", rule: "SQL → JS → CSS → Kontrola", time: "150 min", technologies: ["JS", "SQL", "CSS"], scoreTarget: "~22 / 30 pkt", scoringTotal: "30 pkt", objective: "Projekt Salon." };
export const examSteps: ExamStep[] = [
    { slug: "baza-danych", index: 1, label: "Baza danych", short: "Baza", summary: "Schemat + 4 kwerendy.", minutes: "0-25 min", technologies: ["SQL"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2024/baza-danych.mdx") },
    { slug: "html-php", index: 2, label: "JS", short: "Etap 2", summary: "Polaczenie, renderowanie.", minutes: "25-90 min", technologies: ["JS"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2024/html-php.mdx") },
    { slug: "css", index: 3, label: "CSS", short: "CSS", summary: "Makieta.", minutes: "90-130 min", technologies: ["CSS"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2024/css.mdx") },
    { slug: "kontrola", index: 4, label: "Kontrola", short: "Kontrola", summary: "Ostatnie 20 minut.", minutes: "130-150 min", technologies: ["QA"], mdx: () => import("@/content/inf-03/egzamin-07-styczen-2024/kontrola.mdx") },
];
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-07-styczen-2024:checklist";
