/**
 * Single source of truth dla arkusza INF.03 / styczeń 2026 / 07.
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-07-styczen-2026",
    examId: "INF.03-07",
    session: "Styczeń 2026",
    title: "Arkusz 07 — Stacja meteorologiczna",
    topic: "Stacja meteorologiczna",
    description:
...
export const examSteps: ExamStep[] = [
    {
        ...
        label: "Baza danych",
        short: "Baza",
        summary: "Temperatury, miejscowości, miesiące, AVG/ROUND, INSERT i JOIN.",
        minutes: "0–25 min",
        technologies: ["SQL", "MySQL"],
        mdx: () => import("@/content/inf-03/egzamin-07-styczen-2026/baza-danych.mdx"),
    },
    {
        slug: "html",
        index: 2,
        label: "HTML",
        short: "HTML",
        summary: "Dwa headery, tabela pogody, linki miesięcy GET i stopka.",
        minutes: "25–45 min",
        technologies: ["HTML"],
        mdx: () => import("@/content/inf-03/egzamin-07-styczen-2026/html.mdx"),
    },
    {
        slug: "php",
        index: 3,
        label: "PHP",
        short: "PHP",
        summary: "Tabela temperatur z ikonami, średnia dla miesiąca i odnośniki GET.",
        minutes: "45–90 min",
        technologies: ["PHP", "MySQL"],
        mdx: () => import("@/content/inf-03/egzamin-07-styczen-2026/php.mdx"),
    },
    {
        slug: "css",
        index: 4,
        label: "CSS",
        short: "CSS",
        summary: "Układ headerów 20/80, sekcje, tabela i style zgodne z makietą pogody.",
        minutes: "90–130 min",
        technologies: ["CSS"],
        mdx: () => import("@/content/inf-03/egzamin-07-styczen-2026/css.mdx"),
    },
    {
        slug: "kontrola",
        index: 5,
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-07-styczen-2026/kontrola.mdx"),
    },
];
...
export const examMaterials = {
    ...
    result: {
        ...
        alt: "Makieta lub wynik końcowy INF.03-07 — Stacja meteorologiczna",
        title: "e07-kw5.png",
