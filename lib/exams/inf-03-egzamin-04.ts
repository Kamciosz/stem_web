/**
 * Single source of truth dla arkusza INF.03 / styczeń 2026 / 04.
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-04-styczen-2026",
    examId: "INF.03-04",
    session: "Styczeń 2026",
    title: "Arkusz 04 — Portal maturzystów",
    topic: "Portal maturzystów",
    description:
...
export const examSteps: ExamStep[] = [
    ...
    },
    {
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-04-styczen-2026/kontrola.mdx"),
    },
];
...
export const examMaterials = {
    ...
    result: {
        ...
        alt: "Makieta lub wynik końcowy INF.03-04 — Portal maturzystów",
        title: "e04-kw4.png",
