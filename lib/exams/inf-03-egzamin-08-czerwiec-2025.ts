...
export type ExamMeta = {
    courseId: "inf-03";
    lessonSlug: "egzamin-08-czerwiec-2025";
    examId: string;
    session: string;
    title: string;
    topic: string;
...
export const examMeta: ExamMeta = {
    courseId: "inf-03",
    lessonSlug: "egzamin-08-czerwiec-2025",
    examId: "INF.03-08-CZ25",
    session: "Czerwiec 2025",
    title: "Arkusz 08 — Smoki",
    topic: "Smoki",
    description: "Katalog smokow — fetch i renderowanie.",
    rule: "SQL → JS → CSS → Kontrola",
    time: "150 min",
    technologies: ["JS", "SQL", "CSS"],
    scoreTarget: "~22 / 30 pkt",
    scoringTotal: "30 pkt",
    objective: "Katalog smokow — fetch i renderowanie.",
};
...
export const examSteps: ExamStep[] = [
    {
        ...
        mdx: () => import("@/content/inf-03/egzamin-08-czerwiec-2025/baza-danych.mdx"),
    },
    {
        slug: "html-php",
        index: 2,
        ...
        minutes: "25–90 min",
        technologies: ["JS"],
        mdx: () => import("@/content/inf-03/egzamin-08-czerwiec-2025/html-php.mdx"),
    },
    {
        slug: "css",
        index: 3,
        ...
        minutes: "90–130 min",
        technologies: ["CSS"],
        mdx: () => import("@/content/inf-03/egzamin-08-czerwiec-2025/css.mdx"),
    },
    {
        slug: "kontrola",
        index: 4,
        ...
        minutes: "130–150 min",
        technologies: ["QA"],
        mdx: () => import("@/content/inf-03/egzamin-08-czerwiec-2025/kontrola.mdx"),
    },
];

export const examStrategy = [
    { time: "0–25 min", title: "SQL", body: "Cztery zapytania sprawdzone w bazie.", tag: "łatwe punkty" },
    { time: "25–90 min", title: "JS + baza", body: "Polaczenie, petle, renderowanie.", tag: "tu sie oblewa" },
...
export const EXAM_PROGRESS_STORAGE_KEY = "exam:inf-03:egzamin-08-czerwiec-2025:checklist";
