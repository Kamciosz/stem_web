...
import { examMeta, examSteps, getStepBySlug, toExamStepView } from "@/lib/exams/inf-03-egzamin-02-czerwiec-2025";
...
export function generateStaticParams() {
    return examSteps.map((s) => ({ step: s.slug }));
}
